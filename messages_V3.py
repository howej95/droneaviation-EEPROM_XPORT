...
def get_eeprom_updates_format():
    ...
    update_format = [
        FieldDefinition("value1", "value for the 1st 4 bytes/ 1st & 2nd EEPROM variables", "uint", 1, 0),
        FieldDefinition("value2", "value for the 2nd 4 bytes/ 3rd & 4th EEPROM variables", "uint", 1, 0),
        FieldDefinition("value3", "value for the 3rd 4 bytes/ 5th & 6th EEPROM variables", "uint", 1, 0),
        ...
        FieldDefinition("align2", "byte alignment", "uint", 1, 0)
    ]
